 ...
 * @author Geneshya
 */
public class TagBasedCollaborativeFiltering 
{
    ...
    public TagBasedCollaborativeFiltering() 
    {
    }

    
    public TagBasedCollaborativeFiltering(Rekomendasi rek,JTextArea myText, List<MyImage> imagesPengguna, List<MyImage> imageUserLain)
    {
        this.myText = myText;
    ...
    public void updateInfoAwal()
    {
        ...
        int[] resPred = AlgoritmaTagBased.eksekusiTradisionalFiltering(matriksSemuaUser,indeksPEnggunaAktif,mapUser,mapImage,myText);
        System.out.println("dilempar dari sini");

        rek.tampilkanSemuaImageREkomendasiTagCollaborative(resPred);
    }
     ...
     public double[][] getMatrikSemuaUser()
    {
        ...
        try 
        {
            ...
            {
                data[i] = getSemuaImageYangDiTagUser(pengs.get(i), ims);
            }
            int i = 0;
      ...
      public double[] getSemuaImageYangDiTagUser(Pengguna pengguna,List<MyImage> ims) throws SQLException, IOException, ClassNotFoundException
    {
        List<Integer> ins = KontrollerDatabase.getSemuaImageYAngDiTagPengguna(pengguna.toString());
